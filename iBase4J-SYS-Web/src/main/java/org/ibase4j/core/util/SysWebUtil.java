...
public final class SysWebUtil {
    ...
    public static final void saveCurrentUser(Object user) {
        setSession(SysConstant.SYS_CURRENT_USER, user);
    }
    ...
    public static final void saveCurrentUser(HttpServletRequest request, Object user) {
        setSession(request, SysConstant.SYS_CURRENT_USER, user);
    }
    ...
    public static final Long getCurrentUser() {
        ...
        if (null != currentUser) {
            try {
                ...
                if (null != session) {
                    return (Long) session.getAttribute(SysConstant.SYS_CURRENT_USER);
                }
    ...
    public static final Object getCurrentUser(HttpServletRequest request) {
        try {
            ...
            if (null != session) {
                return session.getAttribute(SysConstant.SYS_CURRENT_USER);
            }
        } catch (InvalidSessionException e) {
            logger.error(e);
        }
    ...
    public static final void removeCurrentUser(HttpServletRequest request) {
        request.getSession().removeAttribute(SysConstant.SYS_CURRENT_USER);
    }

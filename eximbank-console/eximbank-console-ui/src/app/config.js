  ...
  .config(['$controllerProvider', '$compileProvider', '$filterProvider', '$provide',
	...
	.config(function(){
        ...
        jQuery.validator.addMethod('isPassword',function(value,element){
        	var mobileRgx = /^[0-9A-Za-z]+$/;
        	var telRgx =  /[A-Za-z].*[0-9]|[0-9].*[A-Za-z]/;
        	return this.optional(element)||mobileRgx.test(value)||telRgx.test(value)||value.length > 16||value.length<6;
        },'密码为6~12位字母数字组合,且必须包含数字和字母,不能包含特殊符号');

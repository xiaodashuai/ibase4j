...
// 操作控制
appModule.controller('roleUpdateController', ['$scope', '$rootScope', '$state', '$timeout', 'toaster',
	function ($scope, $rootScope, $state, $timeout, toaster) {
		var title = "";
		//设置权限类别是管理权限
		if ($state.includes('**.role.update') != null) {
...
// 菜单树
appModule.directive('menutree', function () {
	return {
		require: '?ngModel',
		restrict: 'A',
		link: function ($scope, element, attrs, ngModel) {
			// 初始化树
			showTree($scope, element, ngModel, 3, 2);
		}
	};
});
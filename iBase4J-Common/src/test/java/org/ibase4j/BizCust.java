...
public class BizCust extends BaseModel implements Serializable {
	...
	public String toString() {
		return new ToStringBuilder(this)
				.append("debtCode", debtCode)
				.append("custNo", custNo)
				.append("custIdType", custIdType)
				.append("organizationCode", organizationCode)
				.append("custNameCN", custNameCN)
				.append("custNameEN", custNameEN)
				.append("custAddressCN", custAddressCN)
				.append("custAddressEN", custAddressEN)
				.append("custBusinessUnit", custBusinessUnit)
				.append("custBusinessUnitName", custBusinessUnitName)
				.append("custRegistrastionType", custRegistrastionType)
				.append("custRegistrastionTypeName", custRegistrastionTypeName)
				.append("custRatingCreditType", custRatingCreditType)
				.append("custRatingCreditTypeName", custRatingCreditTypeName)
				.append("custScale", custScale)
				.append("custScaleName", custScaleName)
				.append("groupNumber", groupNumber)
				.append("groupName", groupName)
				.append("mainBusiness", mainBusiness)
				.append("mainBusinessName", mainBusinessName)
				.append("custCountry", custCountry)
				.append("custCountryName", custCountryName)
				.append("creditRating", creditRating)
				.append("ratiTime", ratiTime)
				.append("ratiBeginTime", ratiBeginTime)
				.append("ratiEndTime", ratiEndTime)
				.append("custManager", custManager)
				.append("creditLinesList", creditLinesList)
				.append("creditLinesId", creditLinesId)
				.append("creditRatio", creditRatio)
				.toString();
	}
}

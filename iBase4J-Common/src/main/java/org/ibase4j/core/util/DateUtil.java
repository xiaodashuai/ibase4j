...
public final class DateUtil {
	...
	/**
	 * 获取格式化（YYYYMMDDHHMMSSSSS）的当前时间
	 * @param date
	 * @return
	 */
	public static final String getTime() {
		Date date = new Date();
		return format(date, DATE_PATTERN.YYYYMMDDHHMMSSSSS);
	}
	 ...
	 * @return
	 */
	public static final String getDateYearNow() {
		return format(new Date(), DATE_PATTERN.YYYY);
	}
	...
	public static Date parseDate(String dateString,String dateFormat) {                  
		...
		try {         
			...
			throw new IllegalArgumentException("error targetResultType:",e);                  
		}   
	}  

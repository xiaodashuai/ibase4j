 ...
 */
@Service
public class BizAuditCheckService extends BaseService<BizAuditCheckProvider, BizAuditCheck> {
	@Reference
	public void setAuditCheckProvider(BizAuditCheckProvider provider) {

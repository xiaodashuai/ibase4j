...
import org.ibase4j.service.BizInterbankService;
...
@RestController
@Api(value = "同业", description = "同业")
@RequestMapping(value = "interbank")
public class BizInterbankController extends BaseController{

    @Autowired
    private BizInterbankService interbankService;
